...
ALTER TABLE order_item ADD CONSTRAINT IDX_order_item_FK0 FOREIGN KEY (o_no) REFERENCES orders (o_no) on delete cascade; --on delete cascade: 부모행이 사라지면 자식행도 사라진다.
