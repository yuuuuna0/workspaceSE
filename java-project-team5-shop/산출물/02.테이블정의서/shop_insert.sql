/********************** member insert ************************/
insert into userId(userid,password,name,email) values('guard1','1111','김경호1','guard1@korea.com');
insert into userId(userid,password,name,email) values('guard2','2222','김경호2','guard2@korea.com');
insert into userId(userid,password,name,email) values('guard3','3333','김경호3','guard3@korea.com');
...
insert 	into cart(cart_no,cart_qty,userid,p_no) values(cart_cart_no_SEQ.nextval,1,'guard2',2);
insert 	into cart(cart_no,cart_qty,userid,p_no) values(cart_cart_no_SEQ.nextval,4,'guard2',7);
...
insert into orders(o_no,o_desc,o_date,o_price,userid)
        values (orders_o_no_SEQ.nextval,'비글외2마리',sysdate,1550000,'guard1');
-- 2. order item insert
