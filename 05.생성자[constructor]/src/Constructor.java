...
<< 생성자메쏘드(constructor) >> : 객체 초기화 메쏘드
	...
	7. 생성자가 하나도 없다면 컴파일러가 디폴트 생성자를 만들어준다 
		-> 다만 다른 생성자가 있으면 디폴트 생성자 만들어주지 않음
...
public class Constructor {
	...
	private int member2;
	/*
	 * 생성자메쏘드: 객체 생성 후 최초로 단 한번 호출되는 메쏘드
	 */
	public Constructor() {
		System.out.println("public Constructor(): 기본(default)생성자 호출:"+this);
		/*
		 * 생성자 메쏘드 안에서는 생성된 객체의 self 참조변수 this를 사용할 수 있다. 
		 */
		this.member1=777;
		this.member2=888;
	}
